/* empty css                                         */
import { c as createComponent, d as createAstro, r as renderComponent, a as renderTemplate, m as maybeRenderHead, e as renderSlot, b as addAttribute } from '../../chunks/astro/server_ed-aK6O1.mjs';
import 'kleur/colors';
...
}, "D:/my-cv/Cv-me/src/layouts/PostLayout.astro", void 0);
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PostLayout", $$PostLayout, { "title": post.title, "description": post.description, "pubDate": post.pubDate, "heroImage": post.heroImage, "updatedDate": post.updatedDate, "badge": post.badge, "tags": post.tags }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "D:/my-cv/Cv-me/src/pages/blog/[slug].astro", void 0);

const $$file = "D:/my-cv/Cv-me/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
